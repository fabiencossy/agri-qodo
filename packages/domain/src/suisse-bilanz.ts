...
export const DEFAULT_SUISSE_BILANZ_CONFIG: SuisseBilanzConfig = {
  besoinNParCulture: {
    ...
    pomme_de_terre: 120,
    betterave_sucre: 130,
    // Pseudocéréales / petites cultures
    sarrasin: 60,
    millet: 70,
    quinoa: 80,
    // Légumineuses (peu/pas de besoin N apporté — fixation symbiotique)
    pois_proteagineux: 0,
    feverole: 0,
    soja: 0,
    lupin: 0,
    ...
    // Composantes pures de mélanges
    luzerne: 0,
    trefle_blanc: 0,
    trefle_violet: 0,
    ray_grass_anglais: 130,
    ray_grass_italie: 140,
    fetuque_elevee: 120,
    dactyle: 110,
    // SPB (fertilisation interdite ou très limitée)
    prairie_extensive: 0,
    prairie_peu_intensive: 30,
    surface_litiere: 0,
    jachere_florale: 0,
    jachere_tournante: 0,
    bande_fleurie: 0,
    ...
    chanvre: 100,
    tabac: 90,
    // Légumes plein champ (Agridea — grandes consommatrices d'N pour la majorité)
    carotte: 90,
    oignon: 100,
    poireau: 180,
    chou_blanc: 220,
    ...
    salade: 90,
    asperge: 100,
    // Vigne & vergers (besoins limités vs grandes cultures, par ha planté)
    vigne: 50,
    verger_pommes: 60,
    verger_poires: 60,
    verger_cerises: 50,
    verger_prunes: 50,
    verger_abricots: 60,
    petits_fruits_fraises: 60,
    petits_fruits_framboises: 70,
  },
  besoinPParCulture: {
    ble_panifiable: 35,
    ble_fourrager: 35,
    ...
    trefle_blanc: 25,
    trefle_violet: 30,
    ray_grass_anglais: 30,
    ray_grass_italie: 35,
    fetuque_elevee: 28,
    dactyle: 25,
    prairie_extensive: 0,
    prairie_peu_intensive: 10,
    surface_litiere: 0,
    jachere_florale: 0,
    jachere_tournante: 0,
    bande_fleurie: 0,
    ...
    verger_prunes: 15,
    verger_abricots: 20,
    petits_fruits_fraises: 25,
    petits_fruits_framboises: 25,
  },
  apportNParUgb: {
    VACHE_LAITIERE: 105,
    GENISSE: 75,
